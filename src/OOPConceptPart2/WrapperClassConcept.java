...
public class WrapperClassConcept {
	...
	public static void main(String[] args) {
		 ...
		 * 8 no of primitive data types. Primitive DTs Wrapper Classes byte
		 * --------------------> java.lang.Byte short-------------------->
		 * java.lang.Short int----------------------> java.lang.Integer
		 * long---------------------> java.lang.Long float-------------------->
		 * java.lang.Float double-------------------> java.lang.Double
		 * char---------------------> java.lang.Character boolean------------------>
		 * java.lang.Boolean Note: Java has provided all the wrapper classes in the form
